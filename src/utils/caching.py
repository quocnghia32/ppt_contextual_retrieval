...
class OpenAICachingManager:
    ...
    def create_cached_embeddings(
        ...
        namespace = namespace or f"openai_embeddings_{model.replace('-', '_')}"
    ...
    def create_cached_llm(
        ...
        **kwargs
        ...
        """
        Create OpenAI LLM with automatic caching.
        ...
        Returns:
            ChatOpenAI instance with caching enabled
        """
        llm = ChatOpenAI(
            model=model,
...
def get_cached_embeddings(model: str = None) -> CacheBackedEmbeddings:
    """
